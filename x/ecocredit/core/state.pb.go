...
type BatchInfo struct {
	...
	// maximum amount of credits that can be minted. Optional, when empty then
	// there is no maximal supply. When the supply (tradeable_amount +
	// retired_amount + escrowed_amount) equals to max_credits the no more credits
	// can be minted. Zero is not a correct value.
	MaxCredits string `protobuf:"bytes,7,opt,name=max_credits,json=maxCredits,proto3" json:"max_credits,omitempty"`
}
...
func (m *BatchInfo) GetMaxCredits() string {
	if m != nil {
		return m.MaxCredits
	}
	return ""
...
var fileDescriptor_6cfdca0a4aaabb36 = []byte{
	...
	,
}
...
func (m *BatchInfo) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	var l int
	_ = l
	if len(m.MaxCredits) > 0 {
		i -= len(m.MaxCredits)
		copy(dAtA[i:], m.MaxCredits)
		i = encodeVarintState(dAtA, i, uint64(len(m.MaxCredits)))
		i--
		dAtA[i] = 0x3a
	}
	if m.EndDate != nil {
...
func (m *BatchInfo) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 7:
			...
			m.MaxCredits = string(dAtA[iNdEx:postIndex])
			iNdEx = postIndex
		default:
			iNdEx = preIndex
			skippy, err := skipState(dAtA[iNdEx:])
