...
var (
	...
	fd_BatchInfo_max_credits protoreflect.FieldDescriptor
)
...
func init() {
	...
	fd_BatchInfo_max_credits = md_BatchInfo.Fields().ByName("max_credits")
}
...
func (x *fastReflection_BatchInfo) Range(f func(protoreflect.FieldDescriptor, protoreflect.Value) bool) {
	...
	if x.MaxCredits != "" {
		value := protoreflect.ValueOfString(x.MaxCredits)
		if !f(fd_BatchInfo_max_credits, value) {
			return
		}
	}
}
...
func (x *fastReflection_BatchInfo) Has(fd protoreflect.FieldDescriptor) bool {
	...
	case "regen.ecocredit.v1.BatchInfo.max_credits":
		return x.MaxCredits != ""
	default:
		if fd.IsExtension() {
...
func (x *fastReflection_BatchInfo) Set(fd protoreflect.FieldDescriptor, value protoreflect.Value) {
	...
	case "regen.ecocredit.v1.BatchInfo.max_credits":
		x.MaxCredits = value.Interface().(string)
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: regen.ecocredit.v1.BatchInfo"))
		}
...
func (x *fastReflection_BatchInfo) Mutable(fd protoreflect.FieldDescriptor) protoreflect.Value {
	...
	case "regen.ecocredit.v1.BatchInfo.max_credits":
		panic(fmt.Errorf("field max_credits of message regen.ecocredit.v1.BatchInfo is not mutable"))
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: regen.ecocredit.v1.BatchInfo"))
		}
...
func (x *fastReflection_BatchInfo) ProtoMethods() *protoiface.Methods {
	...
	marshal := func(input protoiface.MarshalInput) (protoiface.MarshalOutput, error) {
		...
		if len(x.MaxCredits) > 0 {
			i -= len(x.MaxCredits)
			copy(dAtA[i:], x.MaxCredits)
			i = runtime.EncodeVarint(dAtA, i, uint64(len(x.MaxCredits)))
			i--
			dAtA[i] = 0x3a
		}
		if x.EndDate != nil {
	...
	unmarshal := func(input protoiface.UnmarshalInput) (protoiface.UnmarshalOutput, error) {
		...
		for iNdEx < l {
			...
			case 7:
				if wireType != 2 {
					return protoiface.UnmarshalOutput{NoUnkeyedLiterals: input.NoUnkeyedLiterals, Flags: input.Flags}, fmt.Errorf("proto: wrong wireType = %d for field MaxCredits", wireType)
				}
				var stringLen uint64
				for shift := uint(0); ; shift += 7 {
					if shift >= 64 {
				...
				x.MaxCredits = string(dAtA[iNdEx:postIndex])
				iNdEx = postIndex
			default:
				iNdEx = preIndex
				skippy, err := runtime.Skip(dAtA[iNdEx:])
...
func (x *BatchInfo) GetMaxCredits() string {
	if x != nil {
		return x.MaxCredits
	}
	return ""
...
var file_regen_ecocredit_v1_state_proto_rawDesc = []byte{
	...
	0x22, 0xcf, 0x02, 0x0a, 0x09, 0x42, 0x61, 0x74, 0x63, 0x68, 0x49, 0x6e, 0x66, 0x6f, 0x12, 0x0e,
	...
	0x6d, 0x61, 0x78, 0x5f, 0x63, 0x72, 0x65, 0x64, 0x69, 0x74, 0x73, 0x18, 0x07, 0x20, 0x01, 0x28,
	0x09, 0x52, 0x0a, 0x6d, 0x61, 0x78, 0x43, 0x72, 0x65, 0x64, 0x69, 0x74, 0x73, 0x3a, 0x43, 0xf2,
