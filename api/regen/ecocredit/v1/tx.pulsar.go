...
var (
	...
	fd_MsgMintBatch_OriginTx_typ protoreflect.FieldDescriptor
...
func init() {
	...
	fd_MsgMintBatch_OriginTx_typ = md_MsgMintBatch_OriginTx.Fields().ByName("typ")
...
func (x *fastReflection_MsgMintBatch_OriginTx) Range(f func(protoreflect.FieldDescriptor, protoreflect.Value) bool) {
	if x.Typ != "" {
		...
		if !f(fd_MsgMintBatch_OriginTx_typ, value) {
			return
		}
	}
	if x.Id != "" {
...
func (x *fastReflection_MsgMintBatch_OriginTx) Has(fd protoreflect.FieldDescriptor) bool {
	switch fd.FullName() {
	case "regen.ecocredit.v1.MsgMintBatch.OriginTx.typ":
		return x.Typ != ""
...
func (x *fastReflection_MsgMintBatch_OriginTx) Mutable(fd protoreflect.FieldDescriptor) protoreflect.Value {
	switch fd.FullName() {
	case "regen.ecocredit.v1.MsgMintBatch.OriginTx.typ":
		panic(fmt.Errorf("field typ of message regen.ecocredit.v1.MsgMintBatch.OriginTx is not mutable"))
	case "regen.ecocredit.v1.MsgMintBatch.OriginTx.id":
...
func (x *MsgMintBatch_OriginTx) GetTyp() string {
	if x != nil {
		return x.Typ
	}
	return ""
...
var file_regen_ecocredit_v1_tx_proto_rawDesc = []byte{
	...
	0x6f, 0x6d, 0x22, 0xef, 0x01, 0x0a, 0x0c, 0x4d, 0x73, 0x67, 0x4d, 0x69, 0x6e, 0x74, 0x42, 0x61,
	...
	0x52, 0x04, 0x6e, 0x6f, 0x74, 0x65, 0x1a, 0x2c, 0x0a, 0x08, 0x4f, 0x72, 0x69, 0x67, 0x69, 0x6e,
	0x54, 0x78, 0x12, 0x10, 0x0a, 0x03, 0x74, 0x79, 0x70, 0x18, 0x01, 0x20, 0x01, 0x28, 0x09, 0x52,
	0x03, 0x74, 0x79, 0x70, 0x12, 0x0e, 0x0a, 0x02, 0x69, 0x64, 0x18, 0x02, 0x20, 0x01, 0x28, 0x09,
	0x52, 0x02, 0x69, 0x64, 0x22, 0x16, 0x0a, 0x14, 0x4d, 0x73, 0x67, 0x4d, 0x69, 0x6e, 0x74, 0x42,
	0x61, 0x74, 0x63, 0x68, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x22, 0xb4, 0x02, 0x0a,
	...
	0x61, 0x74, 0x61, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x32, 0xc4, 0x07, 0x0a, 0x03,
	...
	0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x12, 0x57, 0x0a, 0x09, 0x4d, 0x69, 0x6e, 0x74, 0x42, 0x61,
	...
	0x6e, 0x74, 0x42, 0x61, 0x74, 0x63, 0x68, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x12,
